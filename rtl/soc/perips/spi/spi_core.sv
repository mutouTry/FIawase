...
module spi_core #(
    ...
    localparam int unsigned TX_FIFO_ADDR_DEPTH   = (TX_FIFO_DEPTH > 1) ? $clog2(TX_FIFO_DEPTH) : 1;
    localparam int unsigned RX_FIFO_ADDR_DEPTH   = (RX_FIFO_DEPTH > 1) ? $clog2(RX_FIFO_DEPTH) : 1;
