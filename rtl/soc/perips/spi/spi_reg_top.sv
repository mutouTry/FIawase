...
module spi_reg_top (
  ...
  // To HW
  output spi_reg2hw_t reg2hw, // Write
  input  spi_hw2reg_t hw2reg, // Read
  ...
  prim_subreg #(
    ...
    // from internal hardware
    .de     (1'b0),//hw2reg.ctrl0.read.de),
    .d      (1'b0),//hw2reg.ctrl0.read.d),
  ...
  assign status_tx_fifo_full_qs = hw2reg.status.tx_fifo_full.d;
  assign reg2hw.status.tx_fifo_full.q = 'd0;

  assign status_tx_fifo_empty_qs = hw2reg.status.tx_fifo_empty.d;
  assign reg2hw.status.tx_fifo_empty.q = 'd0;

  assign status_rx_fifo_full_qs = hw2reg.status.rx_fifo_full.d;
  assign reg2hw.status.rx_fifo_full.q = 'd0;

  assign status_rx_fifo_empty_qs = hw2reg.status.rx_fifo_empty.d;
  assign reg2hw.status.rx_fifo_empty.q = 'd0;

  assign status_busy_qs = hw2reg.status.busy.d;
  assign reg2hw.status.busy.q = 'd0;
