...
`define ProgBuf13           7'h2D  // replaced by Threshold_reg
`define ProgBuf14           7'h2E  // Threshold_count
...
// Custom debug module extensions:  cycle counter
`define Count_reset         7'h49
`define Threshold_reg       7'h50   // Write: threshold value to halt
`define Threshold_count     7'h51   // Read: current cycle counter value
`define Halt_count          7'h52   // Read: current cycle counter value
`define Total_count         7'h53   // Read: current cycle counter value
// Custom debug module extensions:  scan chain   
`define ChainIndex          7'h54
`define ChainInfo           7'h55
`define ScanTargetBase      7'h56
`define ScanWordSelect      7'h57
`define ScanStatus          7'h58
